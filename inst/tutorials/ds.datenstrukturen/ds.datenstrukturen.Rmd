...
```{r 1_2-setup, exercise=FALSE, exercise.setup="1_2", echo=FALSE, include=FALSE}
a <- c(1.2, -13, 46, 1880.12, -2.5)           # Vektor Typ numerisch
```
...
```{r 1_3-setup, exercise=FALSE, exercise.setup="1_3", echo=FALSE, include=FALSE}
a <- c(1.2, -13, 46, 1880.12, -2.5)           # Vektor Typ numerisch
```
...
```{r 1_4-setup, exercise=FALSE, exercise.setup="1_4", echo=FALSE, include=FALSE}
a <- c(1.2, -13, 46, 1880.12, -2.5)           # Vektor Typ numerisch
```
...
```{r 1_6-setup, exercise=FALSE, exercise.setup="1_6", echo=FALSE, include=FALSE}
b <- c(anna = 2.7, rolf = 1.3, heike = 4.0)   # Vektor mit Namen
```
...
Ein Dataframe kann mit der Funktion data.frame() erstellt werden. Einzelne Spalten eines Dataframes können über Index oder mit Hilfe des $-Operators mit der Syntax Dataframename$Spaltenname oder Dataframename[[“Spaltenname“]] angesprochen werden. In Verbindung mit dem Pipe-Operator (%>%) ist dem $ bzw. [[ noch ein Punkt voranzustellen. Soll ein Element eines Dataframes über Indizes adressiert werden, ist eine Notation der Form dataframe[zeile,spalte] möglich. Indizes können auch weggelassen werden und so zum Beispiel mit df[,3] die dritte Spalte des Dataframes, also die Variable Alter, ausgeben. Davon abhängig ob auf einen Dataframe über Index (Syntax: Objekt[Index]) oder Name (Syntax: Objekt$Elementname oder Objekt[[“Elementname“]]) zugegriffen wird, entscheidet sich der Objekttyp, der zurückgegeben wird. Die Ausgabe bei Zugriff über Index ist ein Dataframe während die Ausgabe bei Zugriff über Name ein Vektor sein wird.
...
```{r 5_1-setup, exercise=FALSE, exercise.setup="5_1", echo=FALSE, include=FALSE}
x1 <- c("Tobi","Silke","Klaus","Tobi")   # Vektor x1 (Freunde)
x2 <- c(42, 356, 123, 200)               # Vektor X2 (Facebook Freunde)
x3 <- c(53, 22, 31, 26)                  # Vektor X3 (Alter)
df <- data.frame(Freund=x1, Facebook=x2, Alter=x3)  # Dataframe
...
```{r 5_2-setup, exercise=FALSE, exercise.setup="5_2", echo=FALSE, include=FALSE}
x1 <- c("Tobi","Silke","Klaus","Tobi")   # Vektor x1 (Freunde)
x2 <- c(42, 356, 123, 200)               # Vektor X2 (Facebook Freunde)
x3 <- c(53, 22, 31, 26)                  # Vektor X3 (Alter)
df <- data.frame(Freund=x1, Facebook=x2, Alter=x3)  # Dataframe
...
```{r 5_3-setup, exercise=FALSE, exercise.setup="5_3", echo=FALSE, include=FALSE}
x1 <- c("Tobi","Silke","Klaus","Tobi")   # Vektor x1 (Freunde)
x2 <- c(42, 356, 123, 200)               # Vektor X2 (Facebook Freunde)
x3 <- c(53, 22, 31, 26)                  # Vektor X3 (Alter)
df <- data.frame(Freund=x1, Facebook=x2, Alter=x3)  # Dataframe
...
```{r 5_4-setup, exercise=FALSE, exercise.setup="5_4", echo=FALSE, include=FALSE}
x1 <- c("Tobi","Silke","Klaus","Tobi")   # Vektor x1 (Freunde)
x2 <- c(42, 356, 123, 200)               # Vektor X2 (Facebook Freunde)
x3 <- c(53, 22, 31, 26)                  # Vektor X3 (Alter)
...
```{r 5_5-setup, exercise=FALSE, exercise.setup="5_5", echo=FALSE, include=FALSE}
x1 <- c("Tobi","Silke","Klaus","Tobi")   # Vektor x1 (Freunde)
x2 <- c(42, 356, 123, 200)               # Vektor X2 (Facebook Freunde)
x3 <- c(53, 22, 31, 26)                  # Vektor X3 (Alter)
df2<- data.frame(Freund=x1, Facebook=x2, Alter=x3)  # Dataframe
...
### 5.4 Zugriff auf Tibble

```{r 5_6-setup, exercise=FALSE, exercise.setup="5_6", echo=FALSE, include=FALSE}
x1 <- c("Tobi","Silke","Klaus","Tobi")   # Vektor x1 (Freunde)
x2 <- c(42, 356, 123, 200)               # Vektor X2 (Facebook Freunde)
x3 <- c(53, 22, 31, 26)                  # Vektor X3 (Alter)
df2<- data.frame(Freund=x1, Facebook=x2, Alter=x3)  # Dataframe
