...
# Test für normalverteilte Zufallszahlen
...
# Test für Größe der Studierenden
shapiro.test(studierende$Größe)                    # Nicht normalverteilt, p<0,05
#- Test auf Normalverteilung für mpg, wt, disp der Autos------------------------
ggplot(mtcars)+                                    # Histogramm
  aes(x=mpg)+
  labs(title="Histogramm",subtitle="Autos",x="Meilen pro Gallone",y="Häufigkeit")+
  geom_histogram(binwidth=2)
# Test für Meilen pro Gallone
shapiro.test(mtcars$mpg)                           # Normalverteilt, da p > 0,05
ggplot(mtcars)+                                    # Histogramm
  aes(x=wt)+
  labs(title="Histogramm",subtitle="Autos",x="Gewicht in Pfund",y="Häufigkeit")+
  geom_histogram(binwidth=2)
# Test für Gewicht in Pfund
shapiro.test(mtcars$wt)                            # Normalverteilt, da p > 0,05
ggplot(mtcars)+                                    # Histogramm
  aes(x=disp)+
  labs(title="Histogramm",subtitle="Autos",x="Motorgröße",y="Häufigkeit")+
  geom_histogram(binwidth=2)
# Test für Motorgröße
shapiro.test(mtcars$disp)                          # Nicht normalverteilt, da p < 0,05
# Da sowohl wt als auch mpg normalverteilt sind, lässt sich auch die 
# Pearson Korrelation für diese Variablen berechnen (Voraussetzung: Normalverteilung)
...
mosaic::cor_test(mtcars$wt,mtcars$mpg)                     # Pearson Korrelation
```
