...
Das Kapitel 3.6 wird vorgestellt, wie die Visualisierung und Farbwahl in R unterstützt wird.
...
```{r 1_7-setup, exercise.setup="1_7", exercise=FALSE, echo=FALSE, include=FALSE}
...
```{r 2_7-setup, exercise.setup="2_7", exercise=FALSE, echo=FALSE, include=FALSE}
sp3 <- studierende[1:15,"Note"]                        # Stichprobe 3 (sp3)
```
