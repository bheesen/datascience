...
Folgende Schreibweise bzw. Notation ist in der Wahrscheinlichkeitsrechnung üblich und beschreibt die zugehörigen Berechnungsformeln: ![Formeln](images/formeln.jpg)
...
Wahrscheinlichkeit beim Würfeln: ![Diskret](images/diskret.jpg)
...
Erzeugen Sie sich einen numerischen Vektor mit dem Namen "postion" und den Inhalten von 1 bis 18 für die Tabellenposition der 1. Bundesliga. Wenn alle Mannschaften gleich gut sind, was ist dann die Wahrscheinlichkeit, dass Ihr Lieblingsclub von den 18 Mannschaften nach dem 3. Spieltag auf einer der ersten 6 Tabellenpositionen steht? Ermitteln Sie die Wahrscheinlichkeiten für jede der ersten 6 Tabellenpositionen und lassen Sie sich diese anzeigen.
...
Die Anzeige sollte hinterher wie folgt aussehen: ![bundesliga](images/bundesliga.jpg)
...
Die Anzeige sollte hinterher so ähnlich wie nachfolgende aussehen: ![Temperatur](images/temperatur.jpg)
...
Fügen Sie oberhalb der Funktion rnorm() in Ihrem Code die folgende Zeile ein: set.seed(8735). Wenn Sie  Ihren Code jetzt erneut ausführen, dann sollte das Ergebnis tatsächlich mit dem folgenden übereinstimmen: ![Temperatur2](images/temperatur2.jpg)
...
Die Anzeige sollte hinterher so ähnlich wie folgt aussehen: ![wuerfel](images/wuerfel.jpg)
...
Fügen Sie oberhalb der Funktion sample() in Ihrem Code die folgende Zeile ein: set.seed(8735). Wenn Sie  Ihren Code jetzt erneut ausführen, dann sollte das Ergebnis tatsächlich mit dem folgenden übereinstimmen: ![Wuerfel2](images/wuerfel2.jpg)
...
```{r 2_4_12-setup, exercise.setup="2_4_12", exercise=FALSE, echo=FALSE, include=FALSE}
...
Die Anzeige sollte hinterher wie folgt aussehen: ![Zufallszahlen](images/zufallszahlen.jpg)
...
In dem Vektor fahrer befinden sich die Namen von 15 Fahrern der Formel1. Jeden Monat soll der aus Sicht der Fans beliebteste Fahrer einen Auszeichnung erhalten, was durch ein Online-Voting entschieden wird. Simulieren Sie dieses Voting durch die Erzeugung von Zufallswerte, wobei Sie die Anweisung set.seed(123) vor jeder Erzeugung von Zufallswerten verwenden, so dass die Ergebnisse reproduzierbar sind.
...
Die Anzeige sollte hinterher wie folgt aussehen: ![Zufallswerte](images/zufallswerte.jpg)
...
```{r 2_6-setup, exercise.setup="2_6", exercise=FALSE, echo=FALSE, include=FALSE}
