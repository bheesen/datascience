...
function(variable, name="") {
    ...
    if (is.numeric(variable)){
      ...
      p1<-ggplot2::ggplot(var.df) + ggplot2::aes(x=variable) +
        ...
        ggplot2::geom_vline(ggplot2::aes(xintercept=var.median,color="median",linetype="median"), 
                            linewidth=1)+
        ggplot2::geom_vline(ggplot2::aes(xintercept=var.mean,color="mean",linetype="mean"), 
                            linewidth=2)+
        ggplot2::geom_vline(ggplot2::aes(xintercept=var.modus,color="modus",linetype="modus"), 
                            linewidth=1)+
        ggplot2::scale_color_manual(name="Kennzahl", 
